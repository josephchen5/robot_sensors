...
float magn_ellipsoid_center[3] = {75.4759, 12.5168, -3.11390};
float magn_ellipsoid_transform[3][3] = {{0.908851, 0.0169568, 0.00644599}, {0.0169568, 0.939417, 0.0213383}, {0.00644599, 0.0213383, 0.990699}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = 43.44;
float GYRO_AVERAGE_OFFSET_Y = 56.67;
float GYRO_AVERAGE_OFFSET_Z = -9.45;
